...
export default function InfluencerDashboard() {
  ...
  const influencerHandle = ((influencerData?.name || '')
    .toLowerCase()
    .trim()
    .replace(/[^a-z0-9\s-]/g, '')
    .replace(/\s+/g, '-')
          ...
          <section className="md:col-span-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  to={`/i/${influencerHandle}`}
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm rounded-lg bg-white border border-slate-200 text-slate-700 hover:border-indigo-200 shadow-sm"
                >
                  View Public Profile
                </Link>
                {/* <button
