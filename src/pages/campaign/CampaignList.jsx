  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        ...
        setUserRole(decoded.role || 'influencer');
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-white py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">
              {userRole === 'brand' ? 'Manage your campaigns' : 'Available Campaigns'}
            </h1>
            <p className="text-gray-500 mt-2">
              {userRole === 'brand'
                ? 'Monitor, edit and create campaigns with a modern workflow.'
        ...
        {/* Rest of the component remains the same until the CampaignCard usage */}
        {/* ... existing code ... */}
        ...
        {error ? (
          ...
          <div className="bg-white rounded-2xl border border-dashed border-slate-200 p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              {userRole === 'brand'
                ? 'Kick things off by creating your first campaign.'
...
const CampaignCard = ({ campaign, onDelete, getStatusColor, userRole }) => {
